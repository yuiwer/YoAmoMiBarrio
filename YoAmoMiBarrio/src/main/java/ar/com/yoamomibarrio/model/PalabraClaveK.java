...
/**
 * PalabraClaveK generated by hbm2java
 */
public class PalabraClaveK  implements java.io.Serializable {
    ...
    public PalabraClaveK() {
    }

	
    public PalabraClaveK(String descripcion) {
        this.descripcion = descripcion;
    }
    public PalabraClaveK(String descripcion, String nota) {
       this.descripcion = descripcion;
       this.nota = nota;
    }
