...
/**
 * PalabraClaveH generated by hbm2java
 */
public class PalabraClaveH  implements java.io.Serializable {
    ...
    public PalabraClaveH() {
    }

	
    public PalabraClaveH(String descripcion) {
        this.descripcion = descripcion;
    }
    public PalabraClaveH(String descripcion, String nota) {
       this.descripcion = descripcion;
       this.nota = nota;
    }
