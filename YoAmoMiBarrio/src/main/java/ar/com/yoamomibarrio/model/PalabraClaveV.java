...
/**
 * PalabraClaveV generated by hbm2java
 */
public class PalabraClaveV  implements java.io.Serializable {
    ...
    public PalabraClaveV() {
    }

	
    public PalabraClaveV(String descripcion) {
        this.descripcion = descripcion;
    }
    public PalabraClaveV(String descripcion, String nota) {
       this.descripcion = descripcion;
       this.nota = nota;
    }
