...
/**
 * PalabraClaveD generated by hbm2java
 */
public class PalabraClaveD  implements java.io.Serializable {
    ...
    public PalabraClaveD() {
    }

	
    public PalabraClaveD(String descripcion) {
        this.descripcion = descripcion;
    }
    public PalabraClaveD(String descripcion, String nota) {
       this.descripcion = descripcion;
       this.nota = nota;
    }
