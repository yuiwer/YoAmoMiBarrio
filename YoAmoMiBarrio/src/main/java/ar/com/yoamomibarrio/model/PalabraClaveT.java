...
/**
 * PalabraClaveT generated by hbm2java
 */
public class PalabraClaveT  implements java.io.Serializable {
    ...
    public PalabraClaveT() {
    }

	
    public PalabraClaveT(String descripcion) {
        this.descripcion = descripcion;
    }
    public PalabraClaveT(String descripcion, String nota) {
       this.descripcion = descripcion;
       this.nota = nota;
    }
