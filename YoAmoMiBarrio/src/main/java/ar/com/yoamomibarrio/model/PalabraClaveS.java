...
/**
 * PalabraClaveS generated by hbm2java
 */
public class PalabraClaveS  implements java.io.Serializable {
    ...
    public PalabraClaveS() {
    }

	
    public PalabraClaveS(String descripcion) {
        this.descripcion = descripcion;
    }
    public PalabraClaveS(String descripcion, String nota) {
       this.descripcion = descripcion;
       this.nota = nota;
    }
