...
/**
 * PalabraClaveE generated by hbm2java
 */
public class PalabraClaveE  implements java.io.Serializable {
    ...
    public PalabraClaveE() {
    }

	
    public PalabraClaveE(String descripcion) {
        this.descripcion = descripcion;
    }
    public PalabraClaveE(String descripcion, String nota) {
       this.descripcion = descripcion;
       this.nota = nota;
    }
