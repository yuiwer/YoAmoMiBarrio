...
/**
 * PalabraClaveU generated by hbm2java
 */
public class PalabraClaveU  implements java.io.Serializable {
    ...
    public PalabraClaveU() {
    }

	
    public PalabraClaveU(String descripcion) {
        this.descripcion = descripcion;
    }
    public PalabraClaveU(String descripcion, String nota) {
       this.descripcion = descripcion;
       this.nota = nota;
    }
