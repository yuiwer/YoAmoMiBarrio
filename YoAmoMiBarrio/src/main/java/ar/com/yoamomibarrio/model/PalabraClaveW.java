...
/**
 * PalabraClaveW generated by hbm2java
 */
public class PalabraClaveW  implements java.io.Serializable {
    ...
    public PalabraClaveW() {
    }

	
    public PalabraClaveW(String descripcion) {
        this.descripcion = descripcion;
    }
    public PalabraClaveW(String descripcion, String nota) {
       this.descripcion = descripcion;
       this.nota = nota;
    }
