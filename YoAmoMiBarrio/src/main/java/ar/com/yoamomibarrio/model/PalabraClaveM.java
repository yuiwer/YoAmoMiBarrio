...
/**
 * PalabraClaveM generated by hbm2java
 */
public class PalabraClaveM  implements java.io.Serializable {
    ...
    public PalabraClaveM() {
    }

	
    public PalabraClaveM(String descripcion) {
        this.descripcion = descripcion;
    }
    public PalabraClaveM(String descripcion, String nota) {
       this.descripcion = descripcion;
       this.nota = nota;
    }
