...
/**
 * PalabraClaveL generated by hbm2java
 */
public class PalabraClaveL  implements java.io.Serializable {
    ...
    public PalabraClaveL() {
    }

	
    public PalabraClaveL(String descripcion) {
        this.descripcion = descripcion;
    }
    public PalabraClaveL(String descripcion, String nota) {
       this.descripcion = descripcion;
       this.nota = nota;
    }
