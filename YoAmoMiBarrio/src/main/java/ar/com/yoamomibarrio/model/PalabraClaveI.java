...
/**
 * PalabraClaveI generated by hbm2java
 */
public class PalabraClaveI  implements java.io.Serializable {
    ...
    public PalabraClaveI() {
    }

	
    public PalabraClaveI(String descripcion) {
        this.descripcion = descripcion;
    }
    public PalabraClaveI(String descripcion, String nota) {
       this.descripcion = descripcion;
       this.nota = nota;
    }
