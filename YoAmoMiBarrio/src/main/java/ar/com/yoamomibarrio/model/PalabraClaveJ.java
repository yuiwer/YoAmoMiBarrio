...
/**
 * PalabraClaveJ generated by hbm2java
 */
public class PalabraClaveJ  implements java.io.Serializable {
    ...
    public PalabraClaveJ() {
    }

	
    public PalabraClaveJ(String descripcion) {
        this.descripcion = descripcion;
    }
    public PalabraClaveJ(String descripcion, String nota) {
       this.descripcion = descripcion;
       this.nota = nota;
    }
