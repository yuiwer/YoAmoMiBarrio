...
/**
 * PalabraClaveB generated by hbm2java
 */
public class PalabraClaveB  implements java.io.Serializable {
    ...
    public PalabraClaveB() {
    }

	
    public PalabraClaveB(String descripcion) {
        this.descripcion = descripcion;
    }
    public PalabraClaveB(String descripcion, String nota) {
       this.descripcion = descripcion;
       this.nota = nota;
    }
